...
| 子问题 | 主模型 | 验证或对比 | 核心输出 |
|---|---|---|---|
| Q1 | 状态切换 ARIMAX–GARCH-X | 滚动窗口预测基准 | 油价预测、区间、战争冲击和波动分解 |
| Q2 | 非对称 ARDL–ECM | 局部投影 | 油价正负冲击对中国增长、物价和工业的响应 |
| Q3 | 跨国面板局部投影 | 中国政策反事实模拟 | 各类政策缓冲效应及中国韧性来源 |

模型尚未运行，仓库中不得写入未经真实代码产生的数值结论。
